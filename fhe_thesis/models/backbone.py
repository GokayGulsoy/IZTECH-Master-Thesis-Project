"""Cross-architecture backbone introspection.
...
or DistilBERT. Used by ``replace_activations`` and the Synthesizer
attention surgery so they can operate on any of the three architectures
without duplicating layer-walking code.
